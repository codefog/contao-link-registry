...
$fixtureLoader = function ($class): void {
    ...
    } else if (file_exists(__DIR__.'/../vendor/contao/core-bundle/tests/Fixtures/library/'.$file.'.php')) {
        include_once __DIR__.'/../vendor/contao/core-bundle/tests/Fixtures/library/'.$file.'.php';
        class_alias('Contao\Fixtures\\'.$class, 'Contao\\'.$class);
    }
